package isteriagroup.cryptotracker.config;
...
public class SwaggerConfig {
    private static final String TITLE = "MIPT currency_tracker REST API";
    private static final String DESCRIPTION = "REST API documentation for MIPT currency_tracker";
